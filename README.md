...
**Implemented algorithms:**
 - Depth-first search algorithm (making spanning tree of input graph) <img  width="700" height="350" src="https://github.com/AraKhachatryan/Graph-Algorithms/blob/master/images/dfs.png">
