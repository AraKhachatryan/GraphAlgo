...
**Implemented algorithms:**
 - Depth-first search algorithm (making spanning tree of input graph) <img  width="600" height="300" src="https://github.com/AraKhachatryan/Graph-Algorithms/blob/master/images/dfs.png">
