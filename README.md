...
### Implemented algorithms:
 ...
 - **Dijkstra's shortest path algorithm of weighted graph** <img  width="65%" height="65%" src="https://github.com/AraKhachatryan/Graph-Algorithms/blob/master/img/Dijkstra_algorithm.png">
